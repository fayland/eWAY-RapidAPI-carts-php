<?php
// Heading
$_['heading_title']      = 'eWAY Responsive Shared Page';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified your eWAY module details!';
$_['text_ewaysharedpage']   = '<a onclick="window.open(\'http://www.eway.com.au/\');"><img src="view/image/payment/eway_au.jpg" alt="eWAY AU" title="eWAY Shared Page" style="border: 1px solid #cccccc;" /></a>';
