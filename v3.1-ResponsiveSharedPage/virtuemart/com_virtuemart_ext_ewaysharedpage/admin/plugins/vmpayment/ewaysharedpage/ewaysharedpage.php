...
class plgVMPaymentEwaysharedpage extends vmPSPlugin {
    ...
    function __construct(& $subject, $config) {
        ...
        $varsToPush = array(
            'ewaysharedpage_username'    => array('', 'char'),
            'ewaysharedpage_password'    => array('', 'char'),
            'ewaysharedpage_headertext'  => array('', 'char'),
            'ewaysharedpage_logourl'     => array('', 'char'),
    ...
    protected function getVmPluginCreateTableSQL() {
        return $this->createTableSQL('Payment eWAY Shared Page Table');
    }
    ...
    function getTableSQLFields() {
        $SQLfields = array(
            ...
            'tax_id'                                     => 'smallint(1)',
            'ewaysharedpage_response_raw' => ' text DEFAULT NULL'
        );
        return $SQLfields;
    }
    ...
    function plgVmConfirmedOrder ($cart, $order) {
        ...
        $__logourl = $method->ewaysharedpage_logourl;
        $__headertext = $method->ewaysharedpage_headertext;
        ...
        // Call RapidAPI
        $__username = $method->ewaysharedpage_username;
        $__password = $method->ewaysharedpage_password;
        $eway_params = array();
        ...
        if (isset($lblError)) {
            ...
            $SharedPaymentUrl = $result->SharedPaymentUrl;

            $html = "<meta http-equiv='refresh' content='1;url=$SharedPaymentUrl'><p><a href='$SharedPaymentUrl'>You will be redirected to eWAY, if not, please click here.</a></p>";
        }
    ...
    function plgVmOnPaymentResponseReceived(&$html) {
        ...
        $response_fields['ewaysharedpage_response_raw'] = print_r($result, true);
    ...
    function plgVmOnShowOrderBEPayment($virtuemart_order_id, $payment_method_id) {
        ...
        foreach ($paymentTable as $key => $value) {
            if ($key == 'ewaysharedpage_response_raw') {
