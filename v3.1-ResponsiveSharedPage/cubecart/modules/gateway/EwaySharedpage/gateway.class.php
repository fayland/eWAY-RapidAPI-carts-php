    ...
    public function process() {
        if (isset($_GET['AccessCode'])) {
            ...
            if ($isError) {
                ...
                httpredir(str_replace('modules/gateway/EwaySharedpage/','',$GLOBALS['storeURL'].'/index.php?_a=confirm'), '', 200);
            }
        }

        // do not contain AccessCode again
        // httpredir(currentPage(array('_g', 'type', 'cmd', 'module'), array('_a' => 'complete')));
        httpredir(str_replace('modules/gateway/EwaySharedpage/','',$GLOBALS['storeURL'].'/index.php?_a=complete'), '', 200);
    }
...
//        ini_set("display_errors", 1);
        ...
        $url = $GLOBALS['storeURL'] . '/modules/gateway/EwaySharedpage/return.php';
        ...
        $__logourl = $this->_module['eway_logo_url'];
        $__headertext = $this->_module['eway_header_text'];
        ...
        if (isset($lblError)) {
            ...
            $GLOBALS['smarty']->assign('SharedPaymentUrl', $result->SharedPaymentUrl);
        }
