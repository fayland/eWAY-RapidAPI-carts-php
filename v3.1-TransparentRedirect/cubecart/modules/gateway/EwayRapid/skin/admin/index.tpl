	...
	<div id="Eway" class="tab_content">
  		...
  		<fieldset><legend>{$LANG.module.cubecart_settings}</legend>
			...
			<fieldset>
				...
				<span>
					<select name="module[eway_payment_type]" id="payment_type">
						<option value="USER_PICK">User Pick</option>
						<option value="creditcard" {$SELECT_eway_payment_type_creditcard}>Credit Card</option>
						<option value="paypal" {$SELECT_eway_payment_type_paypal}>PayPal</option>
						<option value="masterpass" {$SELECT_eway_payment_type_masterpass}>MasterPass</option>
						<option value="vme" {$SELECT_eway_payment_type_vme}>V.me By Visa</option>
    				</select>
				</span>
			</div>
			</fieldset>
