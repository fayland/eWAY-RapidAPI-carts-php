...
class plgVMPaymentEway extends vmPSPlugin {
    ...
    function plgVmConfirmedOrder ($cart, $order) {
        ...
        if (isset($lblError)) {
            ...
            $html = '<br /><script language="JavaScript" type="text/javascript" >
//<!--
  var submitcount = 0;
...
//-->
</script><form action="' . $gateway_url . '" method="POST" onsubmit="return avoidDuplicationSubmit()"><input type="hidden" name="EWAY_ACCESSCODE" value="' .
            $AccessCode . '" /><span class="vmpayment_cardinfo">' . JText::_ ('VMPAYMENT_EWAY_COMPLETE_FORM') . '
		    <table border="0" cellspacing="0" cellpadding="2" width="100%">
		    <tr valign="top">
		        <td nowrap width="10%" align="right">
		        	<label for="EWAY_CARDNAME">' . JText::_ ('VMPAYMENT_EWAY_HOLDER') . '</label>
		        </td>
		        <td>
		        <input type="text" class="inputbox" id="EWAY_CARDNAME" name="EWAY_CARDNAME" autocomplete="off" />
		    </td>
		    </tr>
		     <tr valign="top">
		        <td nowrap width="10%" align="right">
		        	<label for="EWAY_CARDNUMBER">' . JText::_ ('VMPAYMENT_EWAY_CCNUM') . '</label>
		        </td>
		        <td>
		        <input type="text" class="inputbox" id="EWAY_CARDNUMBER" name="EWAY_CARDNUMBER" autocomplete="off" />
		    </td>
		    </tr>
		    <tr valign="top">
		        <td nowrap width="10%" align="right">
		        	<label for="EWAY_CARDCVN">' . JText::_ ('VMPAYMENT_EWAY_CVV2') . '</label>
		        </td>
		        <td>
		    ...
		    <tr>
		        ...
		        <td> ';
            $html .= shopfunctions::listMonths('EWAY_CARDEXPIRYMONTH');
            $html .= " / ";
            $options = array();
            $start = date ('Y');
            $end = $start + 7;
            ...
            $html .= JHTML::_('select.genericlist', $options, 'EWAY_CARDEXPIRYYEAR', '', 'value', 'text');
            $html .= '</td> </tr>';
