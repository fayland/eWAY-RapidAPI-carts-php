...
class Gateway {
	...
	public function process() {
	    if (isset($_GET['AccessCode'])) {
	        ...
	        $username = $this->_module['eway_username'];
            $password = $this->_module['eway_password'];
            $livemode = $this->_module['testMode'] ? false : true;
            ...
            $cart_order_id = $result->Options->Option[0]->Value;
...
//        ini_set("display_errors", 1);
        ...
        if (isset($lblError)) {
            ...
            $GLOBALS['smarty']->assign('AccessCode', $AccessCode);
