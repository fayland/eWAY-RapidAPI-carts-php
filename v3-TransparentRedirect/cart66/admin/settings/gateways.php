  ...
  <form id="gatewaySettingsForm" action="" method="post" class="ajaxSettingForm">
    ...
    <div id="gateway-other_gateways" class="pane">
      <?php if(CART66_PRO): ?>
        ...
        <!-- eWAY rapid START -->
        <a href="#" target="_blank" class="eway_rapid_row"><img src="https://cart66.com/images/integrations/eWAY-logo.png" align="left" alt="eWAY Rapid Payment Gateway (AU)"></a>
        <!-- eWAY rapid END -->
        ...
        <table class="form-table">
          <tbody>
            <tr valign="top">
              ...
              <td>
                <select name="auth_url" id="auth_url">
                  ...
                  <!-- eWAY rapid START -->
                  <option id="eway_rapid_url" value="https://api.ewaypayments.com/Soap.asmx?WSDL">eWAY Rapid</option>
                  <!-- eWAY rapid END -->
            ...
            <!-- eWAY rapid START -->
            <tr valign="top" class="eway_rapid_row">
              <th scope="row"><?php _e('eWAY Rapid Sandbox', 'cart66'); ?></th>
              <td>
                <input type="radio" name="eway_rapid_sandbox" id="eway_rapid_sandbox_yes" value="1" <?php echo Cart66Setting::getValue('eway_rapid_sandbox') == 1 ? 'checked="checked" ' : '' ?>/>
                <label for="eway_rapid_sandbox_yes"><?php _e('Yes', 'cart66'); ?></label>
                <input type="radio" name="eway_rapid_sandbox" id="eway_rapid_sandbox_no" value="" <?php echo Cart66Setting::getValue('eway_rapid_sandbox') != 1 ? 'checked="checked" ' : '' ?>/>
                <label for="eway_rapid_sandbox_no"><?php _e('No', 'cart66'); ?></label>
              </td>
            </tr>
            <tr valign="top" class="eway_rapid_row">
              <th scope="row"><?php _e('eWAY API Key', 'cart66'); ?></th>
              <td>
                <input type="text" name="eway_username" id="eway_username" class="regular-text" value="<?php echo Cart66Setting::getValue('eway_username'); ?>" />
              </td>
            </tr>
            <tr valign="top" class="eway_rapid_row">
              <th scope="row"><?php _e('eWAY Password', 'cart66'); ?></th>
              <td>
                <input type="text" name="eway_password" id="eway_password" class="regular-text" value="<?php echo Cart66Setting::getValue('eway_password'); ?>" />
              </td>
            </tr>
            <!-- eWAY rapid END -->
...
<script type="text/javascript">
  ...
  function setGatewayDisplay() {
    ...
    // <!-- eWAY rapid START -->
    $jq('.eway_rapid_row').hide();
    if($jq('#auth_url :selected').attr('id') == 'eway_rapid_url') {
      $jq('.eway_rapid_row').show();
    }
    // <!-- eWAY rapid END -->
